...
public class SqmDeploymentService : ISqmDeploymentService
{
    ...
    /// </summary>
    private Task<(bool success, string output)> RunCommandAsync(int siteId, string command, TimeSpan? timeout = null)
        => _gatewaySsh.RunCommandAsync(siteId, command, timeout);
