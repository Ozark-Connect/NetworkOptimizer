...
///
/// The agent serves plain HTTP on the management LAN, the membership tier polls every three seconds
/// per access point, and anything holding the token can steer or ban a client. The MAC covers
/// method, path, timestamp, nonce and body, so a captured request cannot be replayed or edited
/// either.
/// </summary>
