...
export async function mount(elId) {
    ...
    cpuChart = new ApexCharts(cpuEl, {
        ...
        yaxis: { min: 0, title: { text: 'CPU %', style: { color: '#9ca3af' } }, labels: { style: { colors: '#9ca3af' }, formatter: v => v != null ? v.toFixed(0) + '%' : '' } },
        series: [], colors: PALETTE,
    });
    memChart = new ApexCharts(memEl, {
        ...baseOpts(200, 'Memory %', v => v != null ? v.toFixed(0) + '%' : ''),
        yaxis: { min: 0, title: { text: 'Memory %', style: { color: '#9ca3af' } }, labels: { style: { colors: '#9ca3af' }, formatter: v => v != null ? v.toFixed(0) + '%' : '' } },
        series: [], colors: PALETTE,
    });
