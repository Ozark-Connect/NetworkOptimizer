...
b="d="+u.toFixed(3)+"&u="+p.toFixed(3)+"&p="+c+"&j="+f+"&dd="+(d/1048576).toFixed(3)+"&ud="+(h/1048576).toFixed(3)+"&ua="+k,"undefined"!=typeof clientResultsUrl){var x=document.getElementById("resultsData");x.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href",clientResultsUrl),x.setAttribute("target","_blank"),
// Add click handler for smart window handling
x.onclick=function(e){var t=ze||clientResultsUrl;window.opener&&!window.opener.closed?(e.preventDefault(),window.opener.focus(),window.close()):(e.preventDefault(),window.open(t,"_blank"))}}saveData&&qe(5)}else qe(3);t="busy",clearInterval(r)}},100)}()}"web"===openChannel&&(ue=webRe,oe=!0),"widget"===openChannel&&(ue=widgetRe,oe=!0),"selfwidget"===openChannel&&(ue=widgetRe,l=domainx,x=l),openChannel;var de,he,ce,fe,ge=0,ye=0,ve=0,me=0,we=0,Se=0,De=0,be=0,ke=0,xe=0,Me=0,Re=0,Te=0,Ce=0,Ie=1e3*dlDuration-6e3,Le=1e3*ulDuration-6e3;function Ee(e){if("dl"===e){var t=1e3*w;t>1e3*de+_/2*1e3&&0===De&&(De=1,Se*=.01,ve*=.01,ce=t+1e4),t>=ce&&ce<Ie&&(ce+=1e4,Se*=.01,ve*=.01),ge=R<=0?0:R-ye,ye=R,me=we=t-we,we=t,Se+=me,(ve+=ge)>0&&(v=ve/Se/125*dlAdjust,C=v)}if("up"===e){var o=1e3*m;o>1e3*he+E/2*1e3&&0===Ce&&(Ce=1,Te*=.1,xe*=.1,fe=o+1e4),o>=fe&&fe<Le&&(fe+=1e4,Te*=.1,xe*=.1),be=T<=0?0:T-ke,ke=T,Me=Re=o-Re,Re=o,Te+=Me,(xe+=be)>0&&(v=xe/Te/125*upAdjust,C=v)}}function _e(e){var o=0,n=new XMLHttpRequest;M[e]=n,M[e].open("GET",Ge.Download+"?n="+Math.random(),!0),M[e].onprogress=function(n){if(1===I)return M[e].abort(),M[e]=null,M[e]=void 0,delete M[e],!1;"initDown"==t&&(t="Downloading");var s=n.loaded<=0?0:n.loaded-o;if(isNaN(s)||!isFinite(s)||s<0)return!1;R+=s,o=n.loaded},M[e].onload=function(n){0===o&&(R+=n.total),"initDown"==t&&(t="Downloading"),M[e]&&(M[e].abort(),M[e]=null,M[e]=void 0,delete M[e]),0===I&&_e(e)},M[e].onerror=function(t){0===I&&_e(e)},M[e].responseType="arraybuffer",M[e].send()}var Ge,Fe,Pe,Ae,Be=[];function Ne(o){var n=0,s=new XMLHttpRequest;Be[o]=s,Be[o].open("POST",Ge.Upload+"?n="+Math.random(),!0),Be[o].upload.onprogress=function(e){"initup"==t&&(t="Uploading");if(m>=ulDuration)return Be[o].abort(),Be[o]=null,Be[o]=void 0,delete Be[o],!1;var s=e.loaded<=0?0:e.loaded-n;if(isNaN(s)||!isFinite(s)||s<0)return!1;T+=s,n=e.loaded},Be[o].onload=function(){if(0===n&&(T+=1048576*ulDataSize,m>=ulDuration))return Be[o].abort(),Be[o]=null,Be[o]=void 0,delete Be[o],!1;"initup"==t&&(t="Uploading");Be[o]&&(Be[o].abort(),Be[o]=null,Be[o]=void 0,delete Be[o]),1===I&&Ne(o)},Be[o].onerror=function(e){m<=ulDuration&&Ne(o)},Be[o].setRequestHeader("Content-Type","application/octet-stream"),o>0&&T<=17e3||Be[o].send(e)}var Ue=-1,Oe=[],je=[],He=[],Je=openSpeedTestServerList.length;function We(){if(Je=openSpeedTestServerList.length,t="Ping",performance.clearResourceTimings(),Ue<Je-1)Ue++,"Stop"!=Ae&&function(e,t){var o=0,n=[],i=[];function r(){if(o<pingSamples)o++,"Stop"!=Ae&&a();else if(n.length>1){i.sort(function(e,t){return e-t});var s=(i=(i=i.slice(0,i.length*jitterFinalSample)).reduce(function(e,t){return e+t},0)/i.length).toFixed(1),r=Math.min.apply(Math,n);Oe.push(r),je.push(e),He.push(s),"function"==typeof t&&t()}else"function"==typeof t&&t()}function a(){var t=new XMLHttpRequest;"Stop"!=Ae&&t.abort(),t.open(pingMethod,e[pingFile]+"?n="+Math.random(),!0),t.timeout=pingTimeOut;var a=window.performance.now();t.send(),t.onload=function(){if(200===this.status&&4===this.readyState){var e,t=Math.floor(window.performance.now()-a),l=performance.getEntries();if(e="xmlhttprequest"===(l=l[l.length-1]).initiatorType?parseFloat(l.duration.toFixed(1)):t,o>250&&(e=t),e<=0?n.push(.1):n.push(e),n.length>1){var u=Math.abs(n[n.length-1]-n[n.length-2]).toFixed(1);i.push(parseFloat(u)),s.LiveSpeed(e,"Ping"),s.pingResults(e,"Ping"),s.jitterResult(u,"Jitter")}r()}404===this.status&&4===this.readyState&&(o++,r())},t.onerror=function(e){o++,r()},t.ontimeout=function(e){o++,r()}}a()}(openSpeedTestServerList[Ue],We);else if(je.length>=1){var e=Math.min.apply(Math,Oe),o=Oe.indexOf(e);Ge=je[o],Fe=e,Pe=He[o],Ae="Busy",s.LiveSpeed(Fe,"Ping"),s.pingResults(Fe,"Ping"),s.jitterResult(Pe,"Jitter"),c=Fe,f=Pe,t=ee?"Ping"==ee?"SendR":ee:"Download"}else je.Download||(t="Error")}var ze=null,Ve=function(e,t,o){var n=document.getElementById("save-notification");n&&(n.textContent=e,n.className="save-notification show"+(t?" "+t:""),n.onclick=null,"success"===t?setTimeout(function(){Ve("View Results →","clickable",ze)},2e3):"error"===t?setTimeout(function(){n.className="save-notification"},3e3):"clickable"===t&&o&&(n.onclick=function(){
// If spawned by opener (main app), close this window
window.opener&&!window.opener.closed?(window.opener.focus(),window.close()):(
// Otherwise open in new tab
window.open(o,"_blank"),n.className="save-notification")}))},qe=function(e){var t=new XMLHttpRequest,o=OpenSpeedTestdb;1==e&&(o=webIP),5==e&&(o=saveDataURL),7==e&&(o=get_IP),t.open("POST",o,!0),t.setRequestHeader("Content-type","application/x-www-form-urlencoded"),t.onreadystatechange=function(){if(4==t.readyState&&200==t.status){if(y=t.responseText.trim(),2==e&&(i=y),1==e&&(l=y),3==e&&setTimeout(function(){location.href=ue+y},1500),5==e){
// Update results link with the saved result ID
try{var o=JSON.parse(y);if(o.id&&"undefined"!=typeof clientResultsUrl){ze=clientResultsUrl+"#result-"+o.id;var n=document.getElementById("resultsData");n&&n.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href",ze)}}catch(e){
// Response wasn't JSON, use base URL
ze="undefined"!=typeof clientResultsUrl?clientResultsUrl:null}Ve("Result saved.","success")}6==e&&(openSpeedTestServerList=JSON.parse(y),G=!0,se()),7==e&&(s.YourIP.el.textContent=y)}4==t.readyState&&200!=t.status&&5==e&&Ve("Failed to save result.","error")},2==e&&(g="r=n"),3==e&&(g="r=l&d="+u+"&u="+p+"&dd="+d/1048576+"&ud="+h/1048576+"&p="+c+"&do="+x+"&S="+i+"&sip="+l+"&jit="+f+"&ua="+k),5==e&&(g=b),6==e&&(g="r=s"),t.send(g)}};e.Start=function(){new l}}(window.OpenSpeedTest=window.OpenSpeedTest||{});