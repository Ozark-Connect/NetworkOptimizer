...
ze="undefined"!=typeof clientResultsUrl?clientResultsUrl:null}Ve("Result saved.","success")}6==e&&(openSpeedTestServerList=JSON.parse(y),G=!0,se()),7==e&&(s.YourIP.el.textContent=y)}4==t.readyState&&200!=t.status&&5==e&&Ve("Failed to save result.","error")},2==e&&(g="r=n"),3==e&&(g="r=l&d="+u+"&u="+p+"&dd="+d/1048576+"&ud="+h/1048576+"&p="+f+"&do="+x+"&S="+i+"&sip="+l+"&jit="+c+"&ua="+k),5==e&&(g=b),6==e&&(g="r=s"),t.send(g)}};e.Start=function(){new l}}(window.OpenSpeedTest=window.OpenSpeedTest||{});