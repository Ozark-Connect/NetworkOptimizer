        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InfluxDbUrl = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false, defaultValue: "http://localhost:8087"),
                    ...
                    InfluxDbBucket = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false, defaultValue: "monitoring"),
                    InfluxDbLongtermBucket = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false, defaultValue: "monitoring_longterm"),
