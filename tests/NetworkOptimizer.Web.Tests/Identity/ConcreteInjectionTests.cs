...
public class ConcreteInjectionTests
{
    ...
    private static readonly HashSet<string> Allowed = new(StringComparer.Ordinal)
    {
        ...
        "Dashboard.razor:SiteManagementService",
        "EnvironmentalCorrelation.razor:WiFiOptimizerService",
        "FloorPlanEditor.razor:SystemSettingsService",
        "GuidedToursCard.razor:SiteManagementService",
        "LicensingSettingsCard.razor:SiteManagementService",
        ...
        "SiteSetupWizard.razor:SiteManagementService",
        "SiteSwitcher.razor:SiteManagementService",
        "SiteTabSync.razor:SiteManagementService",
        "Sites.razor:SiteManagementService",
        "SitesOverviewCard.razor:SiteManagementService",
