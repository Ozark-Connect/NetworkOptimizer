        ...
        using (var context = CreateContext())
        {
            ...
            context.Database.ExecuteSqlRaw(
                ...
                VALUES
                    ...
                    (3, 'abcdefghijklmno', 'eth5', '192.0.2.1', 24, '192.0.2.2', 1, 5, 0, '2026-01-01T00:00:00', '2026-01-01T00:00:00'),
        ...
        using (var context = CreateContext())
        {
            ...
            context.Database.ExecuteSqlRaw(
                ...
                VALUES
                    (1, 'modem0', 'eth4', '192.168.100.1', 24, '192.168.100.2', 1, 5, 0, '2026-01-01T00:00:00', '2026-01-01T00:00:00'),
                    (2, 'modem0', 'eth2', '192.168.200.1', 24, '192.168.200.2', 1, 5, 0, '2026-01-01T00:00:00', '2026-01-01T00:00:00'),
                    (3, 'modem0-2', 'eth5', '192.0.2.1', 24, '192.0.2.2', 1, 5, 0, '2026-01-01T00:00:00', '2026-01-01T00:00:00');
                """);
        }
