...
deploy_application() {
    ...
    # Build .env content and write via printf to avoid heredoc issues
...
# Container IP for path analysis and CORS
...
APP_PASSWORD=${APP_PASSWORD}"
    ...
    # Write .env file using printf (safer than heredoc through pct exec)
