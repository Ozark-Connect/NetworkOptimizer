...
echo ""
echo "Next steps:"
echo "1. Open your Network Optimizer Settings page"
echo "2. Configure the External Speed Test Server section:"
echo "   - Host: $(hostname -I | awk '{print $1}')"
echo "   - Port: $PORT"
echo "   - Name: $SERVER_NAME"
echo "3. Save settings"
echo "4. Navigate to Client WAN Speed Test to run tests"
