...
echo ""
echo "TIP: Enable BBR congestion control on this host for more accurate download"
echo "results over the internet. See DEPLOYMENT.md, Speed Test Server Tuning."
echo ""
